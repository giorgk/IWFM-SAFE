...
! ******************************************************************
  ...
  CONTAINS
      ...
      PROCEDURE,PASS :: CalculateLeftRightHeads      => StrmGWConnector_v41_CalculateLeftRightHeads
      PROCEDURE,PASS :: Calc_Left_Right_Q      => StrmGWConnector_v41_Calc_Left_Right_Q
      PROCEDURE,PASS :: Calc_IncipDesat      => StrmGWConnector_v41_Calc_IncipDesat
...
CONTAINS
  ...
  SUBROUTINE StrmGWConnector_v41_CalculateLeftRightHeads(Connector, GWHeads, iStat)
    CLASS(StrmGWConnector_v41_Type)    :: Connector
    REAL(8),INTENT(IN)                  :: GWHeads(:,:)
    INTEGER,INTENT(OUT)                 :: iStat
    iStat = 0
  END SUBROUTINE StrmGWConnector_v41_CalculateLeftRightHeads

  SUBROUTINE StrmGWConnector_v41_Calc_Left_Right_Q(Connector, iStat)
    CLASS(StrmGWConnector_v41_Type)    :: Connector
    INTEGER,INTENT(OUT)                 :: iStat
    iStat = 0
    !INTEGER,INTENT(IN)                  :: iNNodes
    ...
    !CLASS(AbstractFunctionType),OPTIONAL,INTENT(IN) :: WetPerimeterFunction(:)
  END SUBROUTINE StrmGWConnector_v41_Calc_Left_Right_Q

  SUBROUTINE StrmGWConnector_v41_Calc_IncipDesat(Connector, iStat)
    CLASS(StrmGWConnector_v41_Type)    :: Connector
    INTEGER,INTENT(OUT)                 :: iStat
    iStat = 0
    !INTEGER,INTENT(IN)                  :: iNNodes
    !REAL(8),INTENT(IN)                :: rGWHeads(:),rStrmHeads(:)
    !CLASS(AbstractFunctionType),OPTIONAL,INTENT(IN) :: WetPerimeterFunction(:)
  END SUBROUTINE StrmGWConnector_v41_Calc_IncipDesat

...
! ******************************************************************
  ...
  CONTAINS
      ...
      PROCEDURE,PASS   :: GetSubDataList_ForLocationAndDataType => RootZone_v50_GetSubDataList_ForLocationAndDataType 
      ...
      PROCEDURE,NOPASS :: GetZBudget_MonthlyFlows               => RootZone_v50_GetZBudget_MonthlyFlows
      PROCEDURE,NOPASS :: GetZBudget_AnnualFlows                => RootZone_v50_GetZBudget_AnnualFlows
  ...
  ! -------------------------------------------------------------
  INTEGER,PARAMETER           :: f_inData_AtSubregion                          = 2 , &
                                 f_iLWU_AtSubregion                            = 1 , &
                                 f_iRootZone_AtSubregion                       = 2 
  CHARACTER(LEN=25),PARAMETER :: f_cDataList_AtSubregion(f_inData_AtSubregion) = ['Land and water use budget' , &
                                                                                  'Root zone budget'          ]
...
! ******************************************************************
  ...
  ! -------------------------------------------------------------
  SUBROUTINE RootZone_v50_GetSubDataList_ForLocationAndDataType(RootZone,iLocationType,cDataType,cSubDataList)
    CLASS(RootZone_v50_Type),INTENT(IN)      :: RootZone
    INTEGER,INTENT(IN)                       :: iLocationType
    CHARACTER(LEN=*),INTENT(IN)              :: cDataType
  ...
  ! -------------------------------------------------------------
  FUNCTION RootZone_v50_GetZBudget_NColumns(RootZone,cZBudget) RESULT(iNSubData)
    CLASS(RootZone_v50_Type),INTENT(IN) :: RootZone
  ...
  ! -------------------------------------------------------------
  SUBROUTINE RootZone_v50_GetZBudget_ColumnTitles(RootZone,cZBudget,cUnitAR,cUnitVL,cColTitles,iStat)
    CLASS(RootZone_v50_Type),INTENT(IN)      :: RootZone
  ...
  ! -------------------------------------------------------------
  SUBROUTINE RootZone_v50_GetZBudget_MonthlyFlows(cZBudget,ZBudget,ZoneList,iZoneID,iLUType,cBeginDate,cEndDate,rFactVL,rFlows,cFlowNames,iStat)
     CHARACTER(LEN=*),INTENT(IN)              :: cZBudget
  ...
  ! -------------------------------------------------------------
  SUBROUTINE RootZone_v50_GetZBudget_AnnualFlows(cZBudget,ZBudget,ZoneList,iZoneID,iLUType,cBeginDate,cEndDate,rFactVL,rFlows,cFlowNames,iStat)
     CHARACTER(LEN=*),INTENT(IN)              :: cZBudget
     TYPE(ZBudgetType),INTENT(IN)             :: ZBudget              
     TYPE(ZoneListType),INTENT(IN)            :: ZoneList
     INTEGER,INTENT(IN)                       :: iZoneID,iLUType
  ...
  END SUBROUTINE RootZone_v50_GetZBudget_AnnualFlows

...
! ******************************************************************
  ...
  SUBROUTINE WriteToFile(Header,SystemData,OutFile)
    ...
    !Software version that created the raw Z-Budget data
    CALL OutFile%WriteData(iGroup,f_cAttributesDir,'Software_Version',ScalarAttrData=Header%cSoftwareVersion)
    
    !Z-Budget file descriptor
    CALL OutFile%WriteData(iGroup,f_cAttributesDir,'Descriptor',ScalarAttrData=Header%cDescriptor)
    
    !Flags
    CALL OutFile%WriteData(iGroup,f_cAttributesDir,'lVertFlows_DefinedAtNode',ScalarAttrData=Header%lVertFlows_DefinedAtNode)
    CALL OutFile%WriteData(iGroup,f_cAttributesDir,'lFaceFlows_Defined',ScalarAttrData=Header%lFaceFlows_Defined)
    CALL OutFile%WriteData(iGroup,f_cAttributesDir,'lStorages_Defined',ScalarAttrData=Header%lStorages_Defined)
    CALL OutFile%WriteData(iGroup,f_cAttributesDir,'lComputeError',ScalarAttrData=Header%lComputeError)
    
    !Column numbers for mass balance error computation
    IF (Header%lComputeError) THEN
        CALL OutFile%WriteData(iGroup,f_cAttributesDir,'NErrorInCols',ScalarAttrData=SIZE(Header%iErrorInCols))
        CALL OutFile%WriteData(iGroup,f_cAttributesDir,'NErrorOutCols',ScalarAttrData=SIZE(Header%iErrorOutCols))
    ...
    !ZBudget data columns related information
    CALL OutFile%WriteData(iGroup,f_cAttributesDir,'NData',ScalarAttrData=Header%iNData)
    ...
    !ASCII output data
    CALL OutFile%WriteData(iGroup,f_cAttributesDir,'ASCIIOutput%iLenTitles',ScalarAttrData=Header%ASCIIOutput%iLenTitles)
    CALL OutFile%WriteData(iGroup,f_cAttributesDir,'ASCIIOutput%NTitles',ScalarAttrData=Header%ASCIIOutput%iNTitles)
    CALL OutFile%WriteData(iGroup,f_cAttributesDir,'ASCIIOutput%LenColumnTitles',ScalarAttrData=Header%ASCIIOutput%iLenColumnTitles)
    CALL OutFile%WriteData(iGroup,f_cAttributesDir,'ASCIIOutput%ColumnTitles',ArrayAttrData=Header%ASCIIOutput%cColumnTitles)
    CALL OutFile%WriteData(iGroup,f_cAttributesDir,'ASCIIOutput%NumberFormat',ScalarAttrData=Header%ASCIIOutput%cNumberFormat)
    
    !DSS pathname F parts
    CALL OutFile%WriteData(iGroup,f_cAttributesDir,'DSSFParts',ArrayAttrData=Header%cDSSFParts)

...
! ******************************************************************
  ...
  SUBROUTINE WriteToFile(SystemData,HDFFile)
    ...
    CALL HDFFile%WriteData(iGroup,f_cAttributesDir,'SystemData%NNodes',ScalarAttrData=SystemData%NNodes)
    CALL HDFFile%WriteData(iGroup,f_cAttributesDir,'SystemData%NElements',ScalarAttrData=SystemData%NElements)
    CALL HDFFile%WriteData(iGroup,f_cAttributesDir,'SystemData%NLayers',ScalarAttrData=SystemData%NLayers)
    CALL HDFFile%WriteData(iGroup,f_cAttributesDir,'SystemData%NFaces',ScalarAttrData=SystemData%NFaces)

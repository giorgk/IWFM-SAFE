...
MODULE Class_AppStream_v411
  ...
  USE Class_StrmNode_v411            , ONLY: StrmNode_v411_Type               , &
                                            StrmNode_New                    , &
...
! ******************************************************************
  ...
  ! -------------------------------------------------------------
  PRIVATE
  PUBLIC :: AppStream_v411_Type                                              
 
  
  ! -------------------------------------------------------------
  ! --- APPLICATION STREAMS DATA TYPE
  ! -------------------------------------------------------------
  TYPE,EXTENDS(BaseAppStreamType) :: AppStream_v411_Type
    PRIVATE
    TYPE(StrmNode_v411_Type),ALLOCATABLE :: Nodes(:)
  CONTAINS
    PROCEDURE,PASS :: SetStaticComponent             => AppStream_v411_SetStaticComponent
    PROCEDURE,PASS :: SetStaticComponentFromBinFile  => ReadPreprocessedData
    PROCEDURE,PASS :: SetDynamicComponent            => AppStream_v411_SetDynamicComponent
    PROCEDURE,PASS :: SetAllComponents               => AppStream_v411_SetAllComponents
    PROCEDURE,PASS :: SetAllComponentsWithoutBinFile => AppStream_v411_SetAllComponentsWithoutBinFile
    PROCEDURE,PASS :: GetStrmNodeIDs                 => AppStream_v411_GetStrmNodeIDs
    PROCEDURE,PASS :: GetStrmNodeID                  => AppStream_v411_GetStrmNodeID
    PROCEDURE,PASS :: GetStrmNodeIndex               => AppStream_v411_GetStrmNodeIndex
    PROCEDURE,PASS :: GetNUpstrmNodes                => AppStream_v411_GetNUpstrmNodes
    PROCEDURE,PASS :: GetUpstrmNodes                 => AppStream_v411_GetUpstrmNodes
    PROCEDURE,PASS :: GetStageFlowRatingTable        => AppStream_v411_GetStageFlowRatingTable
    PROCEDURE,PASS :: GetVersion                     => AppStream_v411_GetVersion
    PROCEDURE,PASS :: GetBottomElevations            => AppStream_v411_GetBottomElevations
    PROCEDURE,PASS :: GetNRatingTablePoints          => AppStream_v411_GetNRatingTablePoints
    PROCEDURE,PASS :: KillImplementation             => AppStream_v411_Kill
    PROCEDURE,PASS :: WritePreprocessedData          => AppStream_v411_WritePreprocessedData
    PROCEDURE,PASS :: WriteDataToTextFile            => AppStream_v411_WriteDataToTextFile
    PROCEDURE,PASS :: UpdateHeads                    => AppStream_v411_UpdateHeads
    PROCEDURE,PASS :: ConvertTimeUnit                => AppStream_v411_ConvertTimeUnit
    PROCEDURE,PASS :: ConvertFlowToElev              => AppStream_v411_ConvertFlowToElev
    PROCEDURE,PASS :: Simulate                       => AppStream_v411_Simulate
  END TYPE AppStream_v411_Type
    
    
  ! -------------------------------------------------------------
  ! --- VERSION RELATED ENTITIES
  ! -------------------------------------------------------------
  INTEGER,PARAMETER                    :: iVersion    = 411
  INTEGER,PARAMETER                    :: iLenVersion = 9
  CHARACTER(LEN=iLenVersion),PARAMETER :: cVersion    = '4.11.000'
  INCLUDE 'AppStream_v411_Revision.fi'
  ...
  CHARACTER(LEN=ModNameLen),PARAMETER :: ModName         = 'Class_AppStream_v411::'
...
! ******************************************************************
  ...
  ! -------------------------------------------------------------
  SUBROUTINE AppStream_v411_SetStaticComponent(AppStream,cFileName,AppGrid,Stratigraphy,IsRoutedStreams,StrmGWConnector,StrmLakeConnector,iStat)
    CLASS(AppStream_v411_Type),INTENT(OUT) :: AppStream
    ...
    !Local variables
    CHARACTER(LEN=ModNameLen+32) :: ThisProcedure = ModName // 'AppStream_v411_SetStaticComponent'
    CHARACTER                    :: ALine*100
  ...
  END SUBROUTINE AppStream_v411_SetStaticComponent
  
  
  ! -------------------------------------------------------------
  ! --- INSTANTIATE DYNAMIC PART OF STREAM DATA (GENERALLY CALLED IN SIMULATION)
  ! -------------------------------------------------------------
  SUBROUTINE AppStream_v411_SetDynamicComponent(AppStream,IsForInquiry,cFileName,cWorkingDirectory,TimeStep,NTIME,iLakeIDs,AppGrid,Stratigraphy,StrmLakeConnector,StrmGWConnector,iStat)
    CLASS(AppStream_v411_Type)         :: AppStream
    ...
    !Local variables
    CHARACTER(LEN=ModNameLen+34) :: ThisProcedure = ModName // 'AppStream_v411_SetDynamicComponent'
  ...
  END SUBROUTINE AppStream_v411_SetDynamicComponent
  
  
  ! -------------------------------------------------------------
  ! --- INSTANTIATE COMPLETE STREAM DATA
  ! -------------------------------------------------------------
  SUBROUTINE AppStream_v411_SetAllComponents(AppStream,IsForInquiry,cFileName,cSimWorkingDirectory,TimeStep,NTIME,iLakeIDs,AppGrid,Stratigraphy,BinFile,StrmLakeConnector,StrmGWConnector,iStat)
    CLASS(AppStream_v411_Type),INTENT(OUT) :: AppStream
    LOGICAL,INTENT(IN)                    :: IsForInquiry
    ...
    !Local variables
    CHARACTER(LEN=ModNameLen+30) :: ThisProcedure = ModName // 'AppStream_v411_SetAllComponents'
    ...
    CALL AppStream_v411_SetDynamicComponent(AppStream,IsForInquiry,cFileName,cSimWorkingDirectory,TimeStep,NTIME,iLakeIDs,AppGrid,Stratigraphy,StrmLakeConnector,StrmGWConnector,iStat)
    IF (iStat .EQ. -1) RETURN
  ...
  END SUBROUTINE AppStream_v411_SetAllComponents
  
  
  ! -------------------------------------------------------------
  ! --- INSTANTIATE COMPLETE STREAM DATA WITHOUT INTERMEDIATE BINARY FILE
  ! -------------------------------------------------------------
  SUBROUTINE AppStream_v411_SetAllComponentsWithoutBinFile(AppStream,IsRoutedStreams,IsForInquiry,cPPFileName,cSimFileName,cSimWorkingDirectory,AppGrid,Stratigraphy,TimeStep,NTIME,iLakeIDs,StrmLakeConnector,StrmGWConnector,iStat)
    CLASS(AppStream_v411_Type),INTENT(OUT) :: AppStream
    ...
    !Local variables
    CHARACTER(LEN=ModNameLen+44) :: ThisProcedure = ModName // 'AppStream_v411_SetAllComponentsWithoutBinFile'
    
    !Initialize
    iStat = 0
    
    !Instantiate the static components of the AppStream data
    CALL AppStream_v411_SetStaticComponent(AppStream,cPPFileName,AppGrid,Stratigraphy,IsRoutedStreams,StrmGWConnector,StrmLakeConnector,iStat)
    IF (iStat .EQ. -1) RETURN
    
    !Instantiate the dynamic component of the AppStream data
    CALL AppStream_v411_SetDynamicComponent(AppStream,IsForInquiry,cSimFileName,cSimWorkingDirectory,TimeStep,NTIME,iLakeIDs,AppGrid,Stratigraphy,StrmLakeConnector,StrmGWConnector,iStat)
    IF (iStat .EQ. -1) RETURN
  ...
  END SUBROUTINE AppStream_v411_SetAllComponentsWithoutBinFile
...
! ******************************************************************
  ...
  ! -------------------------------------------------------------
  SUBROUTINE AppStream_v411_Kill(AppStream)
    CLASS(AppStream_v411_Type) :: AppStream
  ...
  END SUBROUTINE AppStream_v411_Kill
...
! ******************************************************************
  ...
  ! --- GET VERSION NUMBER 
  ! -------------------------------------------------------------
  FUNCTION AppStream_v411_GetVersion(AppStream) RESULT(cVrs)
    CLASS(AppStream_v411_Type) :: AppStream
  ...
  END FUNCTION AppStream_v411_GetVersion
  

  ! -------------------------------------------------------------
  ! --- GET STREAM NODE IDS
  ! -------------------------------------------------------------
  PURE SUBROUTINE AppStream_v411_GetStrmNodeIDs(AppStream,iStrmNodeIDs)
    CLASS(AppStream_v411_Type),INTENT(IN) :: AppStream
    INTEGER,INTENT(OUT)                  :: iStrmNodeIDs(:)
    
    iStrmNodeIDs = AppStream%Nodes%ID
    
  END SUBROUTINE AppStream_v411_GetStrmNodeIDs


  ! -------------------------------------------------------------
  ! --- GET STREAM NODE ID GIVEN INDEX
  ! -------------------------------------------------------------
  PURE FUNCTION AppStream_v411_GetStrmNodeID(AppStream,indx) RESULT(iStrmNodeID)
    CLASS(AppStream_v411_Type),INTENT(IN) :: AppStream
  ...
  END FUNCTION AppStream_v411_GetStrmNodeID


  ! -------------------------------------------------------------
  ! --- GET STREAM NODE INDEX GIVEN ID
  ! -------------------------------------------------------------
  PURE FUNCTION AppStream_v411_GetStrmNodeIndex(AppStream,ID) RESULT(Index)
    CLASS(AppStream_v411_Type),INTENT(IN) :: AppStream
  ...
  END FUNCTION AppStream_v411_GetStrmNodeIndex


  ! -------------------------------------------------------------
  ! --- GET RATING TABLE (STAGE VS. FLOW) AT A NODE
  ! -------------------------------------------------------------
  SUBROUTINE AppStream_v411_GetStageFlowRatingTable(AppStream,iNode,Stage,Flow)
    CLASS(AppStream_v411_Type),TARGET,INTENT(IN) :: AppStream
    INTEGER,INTENT(IN)                          :: iNode
    REAL(8),INTENT(OUT)                         :: Stage(:),Flow(:)
    
    !Local variables
    TYPE(StrmNode_v411_Type),POINTER :: pStrmNode
  ...
  END SUBROUTINE AppStream_v411_GetStageFlowRatingTable


  ! -------------------------------------------------------------
  ! --- GET NUMBER OF RATING TABLE POINTS AT A STREAM NODE
  ! -------------------------------------------------------------
  PURE FUNCTION AppStream_v411_GetNRatingTablePoints(AppStream,iStrmNode) RESULT(N)
    CLASS(AppStream_v411_Type),INTENT(IN) :: AppStream
  ...
  END FUNCTION AppStream_v411_GetNRatingTablePoints


  ! -------------------------------------------------------------
  ! --- GET BOTTOM ELEVATIONS
  ! -------------------------------------------------------------
  PURE FUNCTION AppStream_v411_GetBottomElevations(AppStream) RESULT(BottomElev)
    CLASS(AppStream_v411_Type),INTENT(IN) :: AppStream
    REAL(8)                              :: BottomElev(AppStream%NStrmNodes)
    
    BottomElev = AppStream%Nodes%BottomElev
    
  END FUNCTION AppStream_v411_GetBottomElevations
  
  
  ! -------------------------------------------------------------
  ! --- GET NUMBER OF NODES DRAINING INTO A NODE
  ! -------------------------------------------------------------
  FUNCTION AppStream_v411_GetNUpstrmNodes(AppStream,iStrmNode) RESULT(iNNodes)
    CLASS(AppStream_v411_Type),INTENT(IN)  :: AppStream
    INTEGER,INTENT(IN)                    :: iStrmNode
    INTEGER                               :: iNNodes
  ...
  END FUNCTION AppStream_v411_GetNUpstrmNodes
  
  
  ! -------------------------------------------------------------
  ! --- GET NODES DRAINING INTO A NODE
  ! -------------------------------------------------------------
  SUBROUTINE AppStream_v411_GetUpstrmNodes(AppStream,iNode,UpstrmNodes)
    CLASS(AppStream_v411_Type),INTENT(IN)  :: AppStream
    INTEGER,INTENT(IN)                    :: iNode
  ...
  END SUBROUTINE AppStream_v411_GetUpstrmNodes
...
! ******************************************************************
  ...
  SUBROUTINE ReadStreamConfigData(DataFile,Stratigraphy,iGWNodeIDs,StrmGWConnector,StrmLakeConnector,AppStream,iStat)
    ...
    TYPE(StrmGWConnectorType),INTENT(OUT) :: StrmGWConnector
    TYPE(StrmLakeConnectorType)           :: StrmLakeConnector
    TYPE(AppStream_v411_Type)              :: AppStream
    INTEGER,INTENT(OUT)                   :: iStat
  ...
  SUBROUTINE ReadStreamRatingTables(iGWNodeIDs,NRTB,Stratigraphy,StrmGWConnector,DataFile,AppStream,iStat)
    ...
    DO indxNode=1,AppStream%NStrmNodes
        ...
        IF (iNode .EQ. 0) THEN
            CALL SetLastMessage('Stream node ID '//TRIM(IntToText(iStrmNodeID))//' listed for stream rating tables is not in the model!',iFatal,ThisProcedure)
            iStat = -1
            RETURN
        END IF
        ...
        IF (lProcessed(iNode)) THEN
            CALL SetLastMessage('Stream node ID '//TRIM(IntToText(iStrmNodeID))//' has been assigned rating tables more than once!',iFatal,ThisProcedure)
            iStat = -1
            RETURN
        END IF
...
! ******************************************************************
  ...
  ! -------------------------------------------------------------
  SUBROUTINE AppStream_v411_WritePreprocessedData(AppStream,OutFile)
    CLASS(AppStream_v411_Type),INTENT(IN) :: AppStream
  ...
  END SUBROUTINE AppStream_v411_WritePreprocessedData
  
  
  ! -------------------------------------------------------------
  ! --- WRITE PREPROCESSED DATA TO TEXT FILE
  ! -------------------------------------------------------------
  SUBROUTINE AppStream_v411_WriteDataToTextFile(AppStream,iGWNodeIDs,UNITLTOU,FACTLTOU,Stratigraphy,StrmGWConnector,iStat)
    CLASS(AppStream_v411_Type),INTENT(IN) :: AppStream
    INTEGER,INTENT(IN)                   :: iGWNodeIDs(:)
    ...
    DO indxReach=1,AppStream%NReaches
        DO indxNode=AppStream%Reaches(indxReach)%UpstrmNode,AppStream%Reaches(indxReach)%DownstrmNode
          ...
          CALL AppStream_v411_GetUpstrmNodes(AppStream,indxNode,UpstrmNodes)
  ...
  END SUBROUTINE AppStream_v411_WriteDataToTextFile
...
! ******************************************************************
  ...
  ! -------------------------------------------------------------
  SUBROUTINE AppStream_v411_ConvertFlowToElev(AppStream)
    CLASS(AppStream_v411_Type) :: AppStream
  ...
  END SUBROUTINE AppStream_v411_ConvertFlowToElev

  
  ! -------------------------------------------------------------
  ! --- CONVERT TIME UNIT OF STREAMS RELATED ENTITIES
  ! -------------------------------------------------------------
  SUBROUTINE AppStream_v411_ConvertTimeUnit(AppStream,NewUnit)
    CLASS(AppStream_v411_Type)   :: AppStream
  ...
  END SUBROUTINE AppStream_v411_ConvertTimeUnit
  
  
  ! -------------------------------------------------------------
  ! --- CALCULATE STREAM FLOWS
  ! -------------------------------------------------------------
  SUBROUTINE AppStream_v411_Simulate(AppStream,GWHeads,Runoff,ReturnFlow,TributaryFlow,DrainInflows,RiparianET,RiparianETFrac,StrmGWConnector,StrmLakeConnector,Matrix)
    CLASS(AppStream_v411_Type)   :: AppStream
  ...
  END SUBROUTINE AppStream_v411_Simulate

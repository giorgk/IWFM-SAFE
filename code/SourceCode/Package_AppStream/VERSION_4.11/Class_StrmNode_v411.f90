...
! ******************************************************************
  ...
  SUBROUTINE StrmNode_New(NNodes,InFile,Nodes,iStat)
    ...
    TYPE(StrmNode_v411_Type) :: Nodes(NNodes)
...
! ******************************************************************
  ...
  SUBROUTINE StrmNode_WritePreprocessedData(Nodes,OutFile)
    TYPE(StrmNode_v411_Type),INTENT(IN) :: Nodes(:)
